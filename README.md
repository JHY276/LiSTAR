...
## Framework
<img src="https://github.com/JHY276/LiSTAR/blob/main/img/framework.png" width="850px">
...
3. To train and evaluate LiSTAR on a dataset, run the following command:
```bash
python main.py 
```
## BibTex Citation

...
def get_loader_segment(index, data_path, batch_size, win_size=100, step=100, mode='train', dataset='KDD'):
    if (dataset == 'Dodgers'):
        dataset = DodgersSegLoader(data_path, win_size, 1, mode)
    elif (dataset == 'ECG'):
        dataset = ECGSegLoader(data_path, win_size, 1, mode)
    elif (dataset == 'GECCO'):
        ...
        dataset = SensorScopeSegLoader(data_path, win_size, 1, mode)
    elif (dataset == 'SWaT'):
        ...
        dataset = BearingSegLoader(data_path, win_size, 1, mode)
    elif (dataset == 'SMAP'):
